...
<div class="tabbable">
    <div class="tab-content tabs-flat no-padding">
        <div class="tab-pane animated fadeIn no-padding-bottom active" style="padding:20px 20px 0 20px;">
            <div class="row">
                <div class="col-md-12">
                    <g:formRemote role="form" id="edit-chutro" name="form" url="[controller: 'chuTro',action: 'save']" update="show-chuTro">
...
<script>
    ...
    var cancel = function () {
        ...
        var url = "${createLink(controller: 'chuTro', action: 'show')}"
        $.post(url, function (html) {
            $(document).find('#show-chuTro').html(html)
        })
    }
</script>